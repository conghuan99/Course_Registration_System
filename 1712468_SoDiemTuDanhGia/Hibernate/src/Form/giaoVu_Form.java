 ...
 * @author VOCONGHUAN
 */
public class giaoVu_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/qlhk.PNG"))); // NOI18N
        ...
        jLabel1.setText("Chào Mừng Đến Với Trang Giáo Vụ");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        g_qlcanhan_Form g_qlcanhan_Form= new g_qlcanhan_Form();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(giaoVu_Form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new giaoVu_Form().setVisible(true);
            }
        });
    }
